...
def generate_pdf_report(machine_id, rpm, cylinder_name, report_data, health_report_df):
    ...
    if not REPORTLAB_AVAILABLE:
        return generate_html_report(machine_id, rpm, cylinder_name, report_data, health_report_df)
...
def generate_html_report(machine_id, rpm, cylinder_name, report_data, health_report_df):
    ...
    for item in report_data:
        ...
        <div class="anomaly-item">
            <strong class="{status_class}">{item['name']}:</strong> 
    ...
    html_content += """
        <div style="margin-top: 50px; font-size: 0.9em; color: #666;">
            Generated by AI-Powered Machine Diagnostics Analyzer
        </div>
    </body>
    </html>
    """
